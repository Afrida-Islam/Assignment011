...
const ScholarshipDetailsPage = () => {
  ...
  if (!model || !model.scholarshipName) {
    return (
      <div className="text-center p-20 text-red-600 bg-green-100 shadow-lg m-10 rounded-lg">
